...
#ifdef __WIN32__
	#define log_error(fmt, ...)     log_output("ERRO", LOG_LEVEL_ERRO, fmt, __VA_ARGS__);
	#define log_warning(fmt, ...)   log_output("WARN", LOG_LEVEL_WARN, fmt, __VA_ARGS__);
	#define log_info(fmt, ...)      log_output("INFO", LOG_LEVEL_INFO, fmt, __VA_ARGS__);
	#define log_debug(fmt, ...)     log_output("DBUG", LOG_LEVEL_DBUG, fmt, __VA_ARGS__);
	#define log_develop(fmt, ...)   log_output("DEVP", LOG_LEVEL_DEVP, fmt, __VA_ARGS__);
	#define log_verbose(fmt, ...)   log_output("VERB", LOG_LEVEL_VERB, fmt, __VA_ARGS__);
#else
